...
//  WalletHakathon
//
//  Created by Андрей on 30.06.17.
//  Copyright © 2017 HSE. All rights reserved.
//

import UIKit

class StartViewController: UIViewController,BWWalkthroughViewControllerDelegate {

    override func viewDidLoad() {
        super.viewDidLoad()

        let stb = UIStoryboard(name: "Walkthought", bundle: nil)
