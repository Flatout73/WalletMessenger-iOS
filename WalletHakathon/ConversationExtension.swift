...
extension Conversation {
    private class func insertConversation(id: Int, summa: Double, users: [User], transactions: [Transaction], inContext context: NSManagedObjectContext) -> Conversation{
    ...
    class func findOrInsertConversation(id: Int, summa: Double, users: [User], transactions: [Transaction], inContext context: NSManagedObjectContext) -> Conversation {
        ...
        if let conversation = findConversation(id: id, inContext: context) {
            ...
            return insertConversation(id: id, summa: summa, users: users, transactions: transactions, inContext: context)
        }
